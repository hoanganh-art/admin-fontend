...
// ============================================
// 🏪 PHẦN 11: MODAL THÊM/SỬA SẢN PHẨM
// ============================================
...
async function saveProduct() {
  ...
  try {
    ...
    const costPrice = parseFloat(costStr) || 0; // ĐỔI TÊN THÀNH cost_price
    ...
    const formData = {
      ...
      price: price,
      cost_price: costPrice, // ĐÚNG: cost_price (theo migration)
      stock: stock,
